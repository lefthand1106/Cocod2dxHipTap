...
bool QuestionScene::init()
{
  ...
  //  this->setTouchEnabled(true);
    ...
    auto howToPlayLabel = LabelTTF::create("猿のケツと豚のケツが落ちてくる順番通りに\n\nボタンを押していこう。\n\n落ちるスピードはどんどん速くなるよ。\n\n間違って押したらゲームオーバだよ。", "Helvetica-BoldOblique", 25);
...
bool QuestionScene::onTouchBegan(Touch* touch, Event* event){
...
void QuestionScene::onTouchMoved(Touch* touch, Event* event) {
    
    //タッチ中の処理
    
}

void QuestionScene::onTouchEnded(Touch *touch, Event *event){
